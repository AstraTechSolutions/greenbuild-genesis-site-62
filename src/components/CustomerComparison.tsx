    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center animate-bounce-in animate-delay-700">
          <Button className="gradient-emerald text-white font-semibold px-8 sm:px-12 lg:px-16 py-4 sm:py-5 text-lg sm:text-xl lg:text-2xl btn-hover rounded-2xl shadow-professional hover:shadow-interactive">
