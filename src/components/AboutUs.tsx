        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 sm:p-8 lg:p-12 shadow-xl border border-orange-200 animate-fade-in-up">
            ...
            <div className="animate-bounce-in animate-delay-300 mb-6 sm:mb-8">
              <Button className="bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 text-white font-semibold px-6 sm:px-8 lg:px-12 py-3 lg:py-4 rounded-lg btn-hover hover-lift transform transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl text-base sm:text-lg lg:text-xl">
