        ...
        <div className="animate-fade-in-left animate-delay-300 space-y-4 sm:space-y-6">
          ...
          <div className="pt-4 sm:pt-6 animate-bounce-in animate-delay-600">
            ...
            <div className="hidden lg:block">
              <div className="flex justify-center">
                <Button className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold px-12 py-5 rounded-lg btn-hover hover-lift transform transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl text-lg font-inter min-h-[4rem]">
                  Start Your Construction
                </Button>
              </div>
            </div>
