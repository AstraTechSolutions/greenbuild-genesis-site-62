    ...
    >
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="animate-bounce-in animate-delay-700">
          <Button className="w-full max-w-md bg-gradient-to-r from-[#00FF00] to-[#00DD00] hover:from-[#00DD00] hover:to-[#00BB00] text-black font-semibold py-4 text-lg lg:text-xl btn-hover hover-lift transform transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl">
