        ...
        <div className="container mx-auto flex justify-between items-center max-w-7xl">
          ...
          <div className="flex-shrink-0 ml-auto">
            <Button 
              ...
              className="gradient-emerald text-white font-semibold px-2 sm:px-3 lg:px-4 xl:px-6 py-1.5 sm:py-2 lg:py-2.5 text-xs sm:text-sm lg:text-base btn-hover shadow-professional hover:shadow-interactive rounded-lg whitespace-nowrap font-inter"
            >
              Contact Us
            </Button>
          </div>
